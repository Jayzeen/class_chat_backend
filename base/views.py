...
def registerPage(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Error while creating an account')
...
def home(request):
    ...
    context = {'rooms': rooms, 'topics': topics, 
               'rooms_count' : rooms_count, 'activity_messages': activity_messages}
...
def userProfile(request, pk):
    ...
    context = {'user': user, 'rooms': rooms, 'activity_messages': room_messages, 'topics': topics}
...
def updateRoom(request, pk):
    ...
    if request.user != room.host:
        messages.error(request, 'You donot have permission to update room details')
        return redirect('home')
